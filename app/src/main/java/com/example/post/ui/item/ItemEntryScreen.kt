...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = { onValueChange(itemDetails.copy(author = it)) },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text),
            label = { Text(stringResource(R.string.post_author)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
...
private fun ItemEntryScreenPreview() {
    PostTheme {
        ItemEntryBody(itemUiState = ItemUiState(
            ItemDetails(
                title = "Item name", description = "", author = ""
            )
        ), onItemValueChange = {}, onSaveClick = {}, stringResource(R.string.submit_action))
    }
}
